...
def get_filters():
    ...
    month_question = 'Which month would you like to get data about--(all, january, february, ... , june)'
    ...
    day_question = 'Which day would you like to get data about--(all, Monday, Tuesday, ... , Sunday)'
